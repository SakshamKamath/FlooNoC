...
floo_req_t floo_req_mstreq;
floo_rsp_t floo_rsp_mstrsp;

 floo_burst_splitter #(
    .AxiCfg(AxiCfg),
    .MaxReadTxns  ( 4 ), //DOUBT
    .MaxWriteTxns ( 4 ), //DOUBT
    .FullBW       ( 1'b1              ),
    .AddrWidth    ( AxiCfg.AddrWidth ), //DOUBT
    .DataWidth    ( AxiCfg.DataWidth ), //DOUBT
    .IdWidth      ( AxiCfg.InIdWidth ), //DOUBT
    .UserWidth    ( AxiCfg.UserWidth ), //DOUBT
    ...
    .clk_i,
    .rst_ni,
    .slv_req_i    (floo_req_mstreq),
    .slv_resp_o   (floo_rsp_mstrsp),
    .mst_req_o    (floo_req_o),
    .mst_resp_i   (floo_rsp_i)
  ); 
...
floo_axi_chimney  #(
  ...
  .id_i,
  .route_table_i,
  .floo_req_o     (floo_req_mstreq),
  .floo_rsp_i     (floo_rsp_mstrsp),
  .floo_req_i,
  .floo_rsp_o
);
