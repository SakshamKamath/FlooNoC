...
(
  ...
  input axi_in_req_t             [3:0][3:0] cluster_axi_in_req_i,
  output axi_in_rsp_t             [3:0][3:0] cluster_axi_in_rsp_o,
  output axi_out_req_t             [3:0][3:0] cluster_axi_out_req_o,
  input axi_out_rsp_t             [3:0][3:0] cluster_axi_out_rsp_i,
  output axi_out_req_t             [3:0] hbm_axi_out_req_o,
  input axi_out_rsp_t             [3:0] hbm_axi_out_rsp_i
...
floo_axi_chimney_wrap  #(
  ...
  .test_enable_i,
  .sram_cfg_i ( '0 ),
  .axi_in_req_i  ( cluster_axi_in_req_i[0][2] ),
  .axi_in_rsp_o  ( cluster_axi_in_rsp_o[0][2] ),
  .axi_out_req_o ( cluster_axi_out_req_o[0][2] ),
  .axi_out_rsp_i ( cluster_axi_out_rsp_i[0][2] ),
...
floo_axi_chimney_wrap  #(
  ...
  .test_enable_i,
  .sram_cfg_i ( '0 ),
  .axi_in_req_i  ( cluster_axi_in_req_i[0][3] ),
  .axi_in_rsp_o  ( cluster_axi_in_rsp_o[0][3] ),
  .axi_out_req_o ( cluster_axi_out_req_o[0][3] ),
  .axi_out_rsp_i ( cluster_axi_out_rsp_i[0][3] ),
...
floo_axi_chimney_wrap  #(
  ...
  .test_enable_i,
  .sram_cfg_i ( '0 ),
  .axi_in_req_i  ( cluster_axi_in_req_i[1][2] ),
  .axi_in_rsp_o  ( cluster_axi_in_rsp_o[1][2] ),
  .axi_out_req_o ( cluster_axi_out_req_o[1][2] ),
  .axi_out_rsp_i ( cluster_axi_out_rsp_i[1][2] ),
...
floo_axi_chimney_wrap  #(
  ...
  .test_enable_i,
  .sram_cfg_i ( '0 ),
  .axi_in_req_i  ( cluster_axi_in_req_i[1][3] ),
  .axi_in_rsp_o  ( cluster_axi_in_rsp_o[1][3] ),
  .axi_out_req_o ( cluster_axi_out_req_o[1][3] ),
  .axi_out_rsp_i ( cluster_axi_out_rsp_i[1][3] ),
...
floo_axi_chimney_wrap  #(
  ...
  .test_enable_i,
  .sram_cfg_i ( '0 ),
  .axi_in_req_i  ( cluster_axi_in_req_i[2][0] ),
  .axi_in_rsp_o  ( cluster_axi_in_rsp_o[2][0] ),
  .axi_out_req_o ( cluster_axi_out_req_o[2][0] ),
  .axi_out_rsp_i ( cluster_axi_out_rsp_i[2][0] ),
...
floo_axi_chimney_wrap  #(
  ...
  .test_enable_i,
  .sram_cfg_i ( '0 ),
  .axi_in_req_i  ( cluster_axi_in_req_i[2][1] ),
  .axi_in_rsp_o  ( cluster_axi_in_rsp_o[2][1] ),
  .axi_out_req_o ( cluster_axi_out_req_o[2][1] ),
  .axi_out_rsp_i ( cluster_axi_out_rsp_i[2][1] ),
...
floo_axi_chimney_wrap  #(
  ...
  .test_enable_i,
  .sram_cfg_i ( '0 ),
  .axi_in_req_i  ( cluster_axi_in_req_i[2][2] ),
  .axi_in_rsp_o  ( cluster_axi_in_rsp_o[2][2] ),
  .axi_out_req_o ( cluster_axi_out_req_o[2][2] ),
  .axi_out_rsp_i ( cluster_axi_out_rsp_i[2][2] ),
...
floo_axi_chimney_wrap  #(
  ...
  .test_enable_i,
  .sram_cfg_i ( '0 ),
  .axi_in_req_i  ( cluster_axi_in_req_i[2][3] ),
  .axi_in_rsp_o  ( cluster_axi_in_rsp_o[2][3] ),
  .axi_out_req_o ( cluster_axi_out_req_o[2][3] ),
  .axi_out_rsp_i ( cluster_axi_out_rsp_i[2][3] ),
...
floo_axi_chimney_wrap  #(
  ...
  .test_enable_i,
  .sram_cfg_i ( '0 ),
  .axi_in_req_i  ( cluster_axi_in_req_i[3][0] ),
  .axi_in_rsp_o  ( cluster_axi_in_rsp_o[3][0] ),
  .axi_out_req_o ( cluster_axi_out_req_o[3][0] ),
  .axi_out_rsp_i ( cluster_axi_out_rsp_i[3][0] ),
...
floo_axi_chimney_wrap  #(
  ...
  .test_enable_i,
  .sram_cfg_i ( '0 ),
  .axi_in_req_i  ( cluster_axi_in_req_i[3][1] ),
  .axi_in_rsp_o  ( cluster_axi_in_rsp_o[3][1] ),
  .axi_out_req_o ( cluster_axi_out_req_o[3][1] ),
  .axi_out_rsp_i ( cluster_axi_out_rsp_i[3][1] ),
...
floo_axi_chimney_wrap  #(
  ...
  .test_enable_i,
  .sram_cfg_i ( '0 ),
  .axi_in_req_i  ( cluster_axi_in_req_i[3][2] ),
  .axi_in_rsp_o  ( cluster_axi_in_rsp_o[3][2] ),
  .axi_out_req_o ( cluster_axi_out_req_o[3][2] ),
  .axi_out_rsp_i ( cluster_axi_out_rsp_i[3][2] ),
...
floo_axi_chimney_wrap  #(
  ...
  .test_enable_i,
  .sram_cfg_i ( '0 ),
  .axi_in_req_i  ( cluster_axi_in_req_i[3][3] ),
  .axi_in_rsp_o  ( cluster_axi_in_rsp_o[3][3] ),
  .axi_out_req_o ( cluster_axi_out_req_o[3][3] ),
  .axi_out_rsp_i ( cluster_axi_out_rsp_i[3][3] ),
...
floo_axi_chimney_wrap  #(
  ...
  .axi_in_req_i  ( '0 ),
  .axi_in_rsp_o  (    ),
  .axi_out_req_o ( hbm_axi_out_req_o[2] ),
  .axi_out_rsp_i ( hbm_axi_out_rsp_i[2] ),
  .id_i             ( HBM_NI_2_ID       ),
  .route_table_i    ( '0                          ),
...
floo_axi_chimney_wrap  #(
  ...
  .axi_in_req_i  ( '0 ),
  .axi_in_rsp_o  (    ),
  .axi_out_req_o ( hbm_axi_out_req_o[3] ),
  .axi_out_rsp_i ( hbm_axi_out_rsp_i[3] ),
  .id_i             ( HBM_NI_3_ID       ),
  .route_table_i    ( '0                          ),
